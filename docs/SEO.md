...
`og-image.png` is generated by **`npm run generate:favicons`** from **`public/logo.png`** (transparent shield) on a navy 1200×630 canvas when `public/og-image.svg` is absent.
