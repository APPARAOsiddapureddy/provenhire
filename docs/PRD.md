...
**Status:** Current  
**Revenue & limits:** [PRD_REVENUE_AND_BUSINESS_RULES.md](PRD_REVENUE_AND_BUSINESS_RULES.md) · **Verification v2 track:** [PRD_VERIFICATION_PIPELINE_V2.md](PRD_VERIFICATION_PIPELINE_V2.md) · **Code/UI drift log:** [IMPLEMENTATION_CHANGELOG.md](IMPLEMENTATION_CHANGELOG.md) · **Backlog (unbuilt features):** [PRD_TECHNICAL_IMPLEMENTATION_REMAINING.md](PRD_TECHNICAL_IMPLEMENTATION_REMAINING.md)
