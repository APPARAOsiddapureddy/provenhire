...
userWorkspacesRouter.get("/me", requireAuth, requireJobSeeker, listMyUserWorkspacesController);
userWorkspacesRouter.get("/code/:code/leaderboard", getUserWorkspaceLeaderboardController);
userWorkspacesRouter.get("/code/:code/me", requireAuth, requireJobSeeker, getUserWorkspaceMeByCodeController);
userWorkspacesRouter.get("/code/:code", getUserWorkspaceByCodeController);
userWorkspacesRouter.post("/code/:code/join", requireAuth, requireJobSeeker, joinUserWorkspaceByCodeController);
userWorkspacesRouter.post("/code/:code/rounds/:roundId/start", requireAuth, requireJobSeeker, startUserWorkspaceRoundController);
